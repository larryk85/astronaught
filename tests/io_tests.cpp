...
TEST_CASE("File Sink Tests", "[sink][file_sink]") {
   SECTION("Check file sink types") {
      auto sink_so = astro::io::cstd::get_stdio_sink<astro::io::stdio::out>();
      auto sink_se = astro::io::cstd::get_stdio_sink<astro::io::stdio::err>();
      auto sink_sl = astro::io::cstd::get_stdio_sink<astro::io::stdio::log>();
